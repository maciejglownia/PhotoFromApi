...
import com.glownia.maciej.photofromapi.BuildConfig
...
interface PhotosApi {
    ...
    @Headers("Accept-Version: v1", "Authorization: Client-ID $CLIENT_ID") // v1: metadata this API expects, Client-ID: access key
    @GET("photos")
